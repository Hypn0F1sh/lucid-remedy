...
public class AttributeDependentTallFlowerBlock extends TallFlowerBlock {

    final public Holder<Attribute> attribute;

    public AttributeDependentTallFlowerBlock(Properties properties, Holder<Attribute> attribute) {
        super(properties);
